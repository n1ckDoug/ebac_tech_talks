...
const dataDoEvento = new Date("Oct 11, 2024 20:00:00");
...
const contaAsHoras = setInterval(function () {
    ...
    document.querySelector('#contador').innerHTML = `começa em ${diasAteOEvento}d ${horasAteOEvento}h ${minutosAteOEvento}min ${segundosAteOEvento}s`;

    if(distanciaEvento < 0) {
        clearInterval(contaAsHoras);
        document.querySelector('#contador').innerHTML = `está expirado!`;
    }
}, 1000);